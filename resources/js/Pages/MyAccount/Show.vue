<template>
  <div class="mb-4">
    <Link :href="route('my-account.listing.index')">
      ← Go back to Listings
    </Link>
  </div>

  <section class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
    <!-- Show this if there are no offers -->
    <Box v-if="!hasOffers" class="flex md:col-span-7 items-center">
      <div class="w-full text-center font-medium text-gray-500">No offers</div>
    </Box>
    <!-- Show this if there are offers -->
...
import Offer from "@/Pages/MyAccount/Show/Components/Offer.vue";
